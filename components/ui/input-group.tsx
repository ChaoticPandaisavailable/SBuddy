/* eslint-disable jsx-a11y/click-events-have-key-events -- Pointer convenience forwards focus to a keyboard-accessible input, without creating an extra keyboard stop. */
/* eslint-disable jsx-a11y/no-noninteractive-element-interactions -- The group only forwards pointer focus to its keyboard-accessible input. */
...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- Pointer focus forwarding only; the associated input is already keyboard accessible.
      onClick={(e) => {
