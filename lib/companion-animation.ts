...
export const ANIMATION_CLIPS: Record<AnimationState, AnimationClip> = {
  ...
  study: { id: 'study', label: '提笔自习', poseIndex: 4, fps: 30, loopFrames: 240, enterMs: 1600, exitMs: 1500, motion: 'write' },
  ...
  away: { id: 'away', label: '起身离场', poseIndex: 8, fps: 30, loopFrames: 180, enterMs: 2600, exitMs: 180, motion: 'sleep' },
  returning: { id: 'returning', label: '走回座位', poseIndex: 9, fps: 30, loopFrames: 180, enterMs: 2600, exitMs: 160, motion: 'stretch' },
};
